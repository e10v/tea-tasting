...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""To run A/A tests, first define the metrics for the experiment, then call the [`simulate`](https://tea-tasting.e10v.me/api/experiment/#tea_tasting.experiment.Experiment.simulate) method, providing the data and the number of simulations as arguments.""")
    return
