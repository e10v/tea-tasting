...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""By default, tea-tasting assumes that the variant with the lowest ID is a control. Change default behavior using the `control` parameter:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""[`ExperimentResult`](https://tea-tasting.e10v.me/api/experiment/#tea_tasting.experiment.ExperimentResult) is a mapping. Get a metric's analysis result using metric name as a key.""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""By default, methods `to_pretty_dicts`, `to_string`, and `to_html` return a predefined list of attributes. This list can be customized:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Use [`get_config`](https://tea-tasting.e10v.me/api/config/#tea_tasting.config.get_config) without parameters to get a dictionary of global options:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Use [`set_config`](https://tea-tasting.e10v.me/api/config/#tea_tasting.config.set_config) to set a global option value:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""Use [`config_context`](https://tea-tasting.e10v.me/api/config/#tea_tasting.config.config_context) to temporarily set a global option value within a context:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""The result of the analysis is a mapping of `ExperimentResult` objects with tuples (control, treatment) as keys. You can view the result for a selected pair of variants:""")
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.md(r"""By default, tea-tasting does not adjust for multiple hypothesis testing. However, it provides several methods for multiple testing correction. For more details, see the [guide on multiple hypothesis testing](https://tea-tasting.e10v.me/multiple-testing/).""")
    return
